...
namespace Ecommerce_manager.Controllers
{
    public class HangHoasController : Controller
    {
        ...
        public HangHoasController(EcommerceShopContext context)
        {
            _context = context;
        }
        ...
        {
            var ecommerceShopContext = _context.HangHoas.Include(h => h.MaLoaiNavigation).Include(h => h.MaNccNavigation);
